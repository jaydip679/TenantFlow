 ...
 */
router.get('/', authenticate, validate(listSchema), notificationController.listNotifications);
 ...
 */
router.patch('/:notificationId/read', authenticate, validate(notificationIdSchema), notificationController.markAsRead);
